...
export default function Dashboard() {
    ...
    return (
        <div className=" grid grid-cols-2 w-full h-screen ">
            ...
            <SelectionCard title="我要轉職" description="職涯探索" icon="" image="" ButtonAction={() => RedirectToPage("/")} buttonLayout="shadow-[10px_0_20px_2px_rgba(56,120,130,0.7),-10px_0_20px_2px_rgba(84,117,78,0.6)]" subtitle="探索符合您技能與抱負的內部機會" />
